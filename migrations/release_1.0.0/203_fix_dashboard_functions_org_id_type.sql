-- Fix dashboard functions to accept TEXT organization IDs instead of UUID
-- This is necessary because Clerk organization IDs are strings, not UUIDs

-- Drop existing functions first
DROP FUNCTION IF EXISTS get_task_status_counts(UUID);
DROP FUNCTION IF EXISTS get_dashboard_stats(UUID);

-- Recreate get_task_status_counts with TEXT parameter
...
-- Recreate get_dashboard_stats with TEXT parameter
...
COMMENT ON FUNCTION get_task_status_counts(TEXT) IS 'Optimized function to get task statistics with TEXT organization ID parameter';
COMMENT ON FUNCTION get_dashboard_stats(TEXT) IS 'Unified dashboard statistics function with TEXT organization ID parameter';
