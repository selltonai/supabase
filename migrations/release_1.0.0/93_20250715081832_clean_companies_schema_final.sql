-- Migration: Clean Companies Schema Final
-- Description: Final cleanup of companies table to match exact API response format
-- Author: System
-- Date: 2025-07-15
...
BEGIN
  ...
  -- Remove address_line1 column if it exists
  ...
  -- Remove address_line2 column if it exists
  ...
  -- Remove geographic_area column if it exists
...
COMMENT ON TABLE companies IS 'Companies table with final cleaned schema matching API response format';
