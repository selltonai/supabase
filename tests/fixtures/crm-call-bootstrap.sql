...
CREATE TYPE public.task_type AS ENUM ('review_draft','meeting','company_verification','email_generation_processing','review_reply','nurture_reminder','linkedin_connect','manual_outreach');
