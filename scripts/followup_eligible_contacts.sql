-- ============================================================================
-- FOLLOW-UP ELIGIBLE CONTACTS QUERY
-- ============================================================================
...
--   6. Last email > min_hours_between_emails ago (default: 72h)
...
HAVING 
    ...
    -- Last email was sent more than 96 hours ago (adjust min_hours_between_emails here)
    AND MAX(t.sent_at) < NOW() - INTERVAL '96 hours'
...
SELECT 
    ...
    CASE WHEN MAX(t.sent_at) < NOW() - INTERVAL '96 hours' THEN '✅' ELSE '❌ too recent (<96h)' END AS chk_time_elapsed,
